        ...
        <div class="md:w-1/2">
            ...
            @if($post->user_id === auth()->user()->id)
                <form action="{{route('posts.destroy',$post)}}" method="POST">
                    @method('DELETE'){{-- method spoofing permite enviar otro tipo de peticion como put patch delete --}}
                    @csrf
                    <input
                        type="submit"
            ...
            <div class=" shadow bg-white p-5 mb-5">
                ...
                @endif
                    <form action="{{route('comentarios.store',['post' => $post,'user'=>$user])}}" method="POST">
                        @csrf
                        <div class="mb-5">   
                            <label for="comentario" class="mb-2 block uppercase text-gray-500 font-bold" value="{{ old('imagen') }}">
                                Añade un comentario
                            </label>
                        <textarea
                        id="comentario"
